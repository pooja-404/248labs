...
const Gamesec = () => {
    ...
    return (
        <div className='pt-4 pb-lg-5 position-relative z-1 overflow-x-clip' id='about'>
            <div className="container pt-lg-5 pb-3">
                <div className="row py-lg-5">
                    ...
                    <div className="col-lg-6" data-aos="fade-left">
                        ...
                        <p className='font-roboto fs-s lh-24 fw-normal off-gray mb-0 text_c_center max-w-517 '>Web3 Games have a notoriously high barrier-to-entry for casual gamers who make up the vast majority of players. “Link your wallet” before gameplay is not just off-putting, it’s boring. We’re solving that with <span className='fw-bold'>world-class storytelling,</span> world-building, game design, art and sound. And fun.</p>
                    </div>
                </div>
            </div>
