...
import richworld from '../assets/images/richworld.png'

function Richsec() {
    return (
        <div className='py-lg-5 position-relative z-1'>
            <div className="container py-5">
                ...
                <div className='position-relative'>
                    ...
                    <a href="https://www.youtube.com/watch?v=tTkz7hnY8WE" className=" position-absolute vedio-btn">
            ...
            <div className='rich-ellipse position-absolute end-0 rich-top z-n1'></div>
